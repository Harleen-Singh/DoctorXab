...
public class MedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.MedicineViewHolder> {
    ...
    private ArrayList<String> medicine_list;
    private Context context;

    public MedicineAdapter(ArrayList<String> medicine_list, Context context) {
        this.medicine_list = medicine_list;
        this.context = context;
    }

    public void setData(ArrayList<String> medicine_list) {
        this.medicine_list = medicine_list;
    }
    ...
    public void onBindViewHolder(@NonNull MedicineViewHolder holder, int position) {
        holder.binding.editPrescription.setText(medicine_list.get(position));
